...
productRoutes.post("/products/by-ids",getProductsByIds);
...
productRoutes.post(
  "/products/",
  verifyUser, // [MiddleWare]: verify user layer + [check user exist +(store profile)]
...
productRoutes.put(
  "/products/:id",
  checkProductExist, // [MiddleWare]: using id in URL
